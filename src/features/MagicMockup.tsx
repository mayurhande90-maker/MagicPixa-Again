                        ...
                        <div>
                            ...
                            {targetObject === 'Other / Custom' && (
                                <div className="mt-3 animate-fadeIn">
                                    <InputField placeholder="Describe object (e.g. Vintage Hat)" value={customObject} onChange={(e: any) => setCustomObject(e.target.value)} />
                                </div>
                            )}
                        </div>
                                ...
                                <div className={MockupStyles.colorItem}>
                                    <div className={`${MockupStyles.customGroup} ${isCustomActive ? 'border-indigo-400 bg-indigo-50/30' : ''}`}>
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            <input type="text" ref={hexInputRef} className={MockupStyles.customHexInput} placeholder="Hex" value={objectColor && objectColor.startsWith('#') ? objectColor.replace('#', '') : ''} onChange={handleHexChange} />
                                        </div>
                                    </div>
