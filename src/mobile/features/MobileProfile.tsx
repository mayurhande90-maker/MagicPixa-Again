...
export const MobileProfile: React.FC<{ auth: AuthProps; appConfig: AppConfig | null }> = ({ auth, appConfig }) => {
    ...
    return (
        <div className="flex flex-col h-full bg-[#FAFBFF] overflow-y-auto no-scrollbar pb-32 animate-fadeIn">
            ...
            {/* 1. IDENTITY HUB (Layered Isolation Fix) */}
            <div className="relative z-20 flex-none bg-white border-b border-gray-50 pt-12 pb-24 px-6 flex flex-col items-center text-center overflow-visible">
