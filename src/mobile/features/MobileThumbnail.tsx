                                                ...
                                                {isPodcast ? (
                                                    <div className="space-y-4">
                                                        <div className="grid grid-cols-2 gap-4">
                                                            <CompactUpload label="Host Photo" image={hostImg} onUpload={handleUpload(setHostImg)} onClear={() => setHostImg(null)} icon={<UploadTrayIcon className="w-6 h-6 text-purple-400"/>} />
                                                            <CompactUpload label="Guest Photo" image={guestImg} onUpload={handleUpload(setGuestImg)} onClear={() => setGuestImg(null)} icon={<UploadTrayIcon className="w-6 h-6 text-indigo-400"/>} />
                                                        </div>
                                                    ...
                                                    <div className="space-y-4">
                                                        <div className="grid grid-cols-2 gap-4">
                                                            <CompactUpload label="Your Photo" image={subjectImg} onUpload={handleUpload(setSubjectImg)} onClear={() => setSubjectImg(null)} icon={<UploadTrayIcon className="w-6 h-6 text-blue-400"/>} optional={true} />
