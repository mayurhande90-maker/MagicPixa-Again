...
// FIX: Switched from a non-working namespace import to named imports for Firebase app initialization, which is the standard for the modular SDK.
...
if (isConfigValid) {
  try {
    // FIX: Initialize Firebase app using named-imported functions.
