...
// FIX: Using namespace import for firebase/app to resolve module export issue.
...
if (isConfigValid) {
  try {
    // FIX: Using namespace import for firebase/app functions to resolve module export issues.
