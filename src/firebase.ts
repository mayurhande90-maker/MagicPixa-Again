...
// FIX: Switched from an incorrect namespace import to named imports for 'firebase/app' as required by the Firebase v9+ modular SDK.
...
if (isConfigValid) {
  try {
    // FIX: Correctly initialize Firebase app using named-exported functions.
