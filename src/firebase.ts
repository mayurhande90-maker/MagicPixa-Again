...
// FIX: Use named imports for firebase/app to align with other Firebase imports and resolve module errors.
...
if (isConfigValid) {
  try {
    // FIX: Use named imports for firebase/app functions for consistency and to resolve property access errors.
