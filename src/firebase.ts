...
// FIX: The named imports from 'firebase/app' are failing, indicating a potential module resolution issue with the current setup. Switching to a namespace import (`import * as firebase from 'firebase/app'`) as a workaround.
...
if (isConfigValid) {
  try {
    // FIX: Using namespace-based function calls to match the namespace import workaround for 'firebase/app'.
