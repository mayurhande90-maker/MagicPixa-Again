...
// FIX: Use named imports for Firebase v9+ modular SDK functions instead of a namespace import.
...
if (isConfigValid) {
  try {
    // FIX: Use named imports for Firebase app functions, which is the correct pattern for the v9+ modular SDK.
