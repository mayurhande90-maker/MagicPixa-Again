...
export const MobileTryOnStyles = {
    ...
    optionActive: "bg-rose-600 text-white border-rose-600 shadow-rose-200 shadow-xl",
    ...
    shelfItem: "w-10 h-12 bg-white rounded-lg border border-rose-100 p-1 flex items-center justify-center overflow-hidden shadow-sm",
    
    // Animations
    weaveScan: "absolute inset-0 z-40 pointer-events-none",
    scanLine: "absolute top-0 h-full w-[2px] bg-rose-400 shadow-[0_0_15px_#fb7185] animate-weave-scan",
    
    // Navigation
    backBtn: "p-2 rounded-full bg-gray-100 text-gray-500 active:bg-gray-200",
    creditsPill: "flex items-center gap-1.5 bg-rose-50 px-3 py-1.5 rounded-full border border-rose-100",
    
    // Custom Refine Sheet Icon
    refineIcon: "w-5 h-5 text-rose-500"
};
