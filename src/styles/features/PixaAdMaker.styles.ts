export const AdMakerStyles = {
  // Container
  modeGrid: "grid grid-cols-2 gap-6 h-full content-start px-4 py-2",
  formContainer: "space-y-8 p-2 animate-fadeIn flex flex-col h-full relative",

  // Base Card - Apple/Bento Style
  modeCard: "group relative w-full h-[clamp(140px,20vh,180px)] rounded-[1.8rem] overflow-hidden transition-all duration-500 ease-out hover:shadow-xl hover:shadow-gray-200 hover:-translate-y-1 border border-white/60 text-left cursor-pointer",
