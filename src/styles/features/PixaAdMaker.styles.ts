export const AdMakerStyles = {
  ...
  // Compact Aspect Ratio Styles (Match SelectionGrid)
  ratioButton: "flex items-center gap-2 px-3 py-1.5 rounded-xl text-[10px] font-bold border transition-all duration-300 transform active:scale-95",
