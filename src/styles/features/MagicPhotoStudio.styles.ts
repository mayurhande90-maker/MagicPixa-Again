export const PhotoStudioStyles = {
  ...
  modeCard: "group relative w-full h-64 rounded-[2rem] overflow-hidden transition-all duration-500 ease-out hover:shadow-2xl hover:shadow-gray-200 hover:-translate-y-2 border border-white/60 text-left bg-white",
  ...
  promptButton: "group relative w-full text-left rounded-xl transition-all duration-300 transform hover:-translate-y-0.5 mb-2 last:mb-0 cursor-pointer overflow-hidden p-[1px]",
  promptButtonActive: "bg-gradient-to-r from-blue-500 to-purple-600 shadow-md scale-[1.01]",
  promptButtonInactive: "bg-transparent hover:bg-gradient-to-r hover:from-blue-200 hover:to-purple-200",
  
  promptBorder: "absolute inset-0 opacity-0 transition-opacity duration-300",
  promptContent: "relative w-full p-3 rounded-[11px] flex items-center justify-between z-10 transition-colors",
  
  promptText: "text-xs font-medium italic transition-colors line-clamp-2",
  promptTextActive: "text-white font-bold",
  promptTextInactive: "text-gray-600 bg-white/90 backdrop-blur-sm group-hover:bg-white",

  // Selection Buttons (Compact Pills - Reverted from Bento)
  categoryGrid: "flex flex-wrap gap-2", // Changed from grid to flex-wrap
  categoryBtn: "px-4 py-2.5 rounded-lg text-xs font-bold border transition-all duration-200 transform active:scale-95 cursor-pointer",
  categoryBtnActive: "bg-[#1A1A1E] text-white border-[#1A1A1E] shadow-lg scale-105",
  categoryBtnInactive: "bg-white text-gray-600 border-gray-200 hover:border-gray-400 hover:text-gray-900 hover:bg-gray-50",
  
  // Instruction Banner
  instructionBanner: "flex items-start gap-3 bg-blue-50 border border-blue-100 rounded-xl p-4 mb-6 shadow-sm",
  instructionIcon: "w-5 h-5 text-blue-600 mt-0.5 flex-shrink-0",
  instructionText: "text-sm text-blue-800 font-medium leading-relaxed",
  
  // Navigation
  backButton: "group flex items-center gap-2 text-xs font-bold text-gray-400 hover:text-indigo-600 transition-colors py-2 px-1 mb-2 w-fit",
