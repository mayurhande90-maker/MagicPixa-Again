...
export const FoodIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 9.75l4.5 4.5m0-4.5l-4.5 4.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /> {/* Simplified pizza/plate */}
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 8.25v.008m0 2.242v.008m0 2.242v.008" /> 
    </svg>
);
