...
export const PixaHeadshotIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36">
        <path fill="#FFAC33" d="M18 34C9.164 34 2 26.836 2 18S9.164 2 18 2s16 7.164 16 16s-7.164 16-16 16z"/>
        <path fill="#F4900C" d="M18 4C10.268 4 4 10.268 4 18s6.268 14 14 14s14-6.268 14-14S25.732 4 18 4z"/>
        <path fill="#3B88C3" d="M18 27c-3.859 0-7-3.141-7-7v-3c0-3.859 3.141-7 7-7s7 3.141 7 7v3c0 3.859-3.141 7-7 7z"/>
        <path fill="#55ACEE" d="M18 25c-2.757 0-5-2.243-5-5v-3c0-2.757 2.243-5 5-5s5 2.243 5 5v3c0 2.757-2.243 5-5 5z"/>
        <path fill="#66757F" d="M26 30.031c0-4.418-3.582-8-8-8s-8 3.582-8 8v1.001c0 .535.432.968.965.968h14.07c.533 0 .965-.434.965-.968v-1.001z"/>
    </svg>
);
