...
// Pixa Headshot Icon - Re-added as it's a core feature icon
export const PixaHeadshotIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
        <g fill="none">
            ...
            {/* Brand Blue Tie */}
            <path fill="#4D7CFF" d="M16 13.706a3.09 3.09 0 0 1-1.508-.385c-.153-.085-.306.097-.214.246c.367.587.999.982 1.722.982c.724 0 1.356-.395 1.723-.982c.092-.15-.071-.32-.214-.246a3.12 3.12 0 0 1-1.509.385Z"/>
        </g>
    </svg>
);
