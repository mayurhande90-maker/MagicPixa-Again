...
export const ThumbUpIcon: React.FC<IconProps> = (props) => (
    <BaseIcon {...props} path={<path strokeLinecap="round" strokeLinejoin="round" d="M6.633 10.5c.806 0 1.533-.446 2.031-1.08a9.041 9.041 0 012.861-2.4c.723-.384 1.35-.956 1.653-1.715a4.498 4.498 0 00.322-1.672V3a2.25 2.25 0 012.25 2.25V7.38a2.25 2.25 0 11-4.5 0 .75.75 0 00-1.5 0v2.003c0 .083.006.166.017.248a3.75 3.75 0 013.744 3.712v1.5a3.75 3.75 0 01-3.75 3.75H13.5m-3.375-3.375h-.75c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125h.75a1.125 1.125 0 011.125 1.125v3c0 .621-.504 1.125-1.125 1.125h-3.75a1.125 1.125 0 01-1.125-1.125V8.625a1.125 1.125 0 011.125-1.125h.75c.621 0 1.125-.504 1.125-1.125v-1.125c0-1.242.253-2.37 1.01-3.237.33-.377.765-.63 1.229-.71" />} />
);

export const ThumbDownIcon: React.FC<IconProps> = (props) => (
    <BaseIcon {...props} path={<path strokeLinecap="round" strokeLinejoin="round" d="M7.5 15h2.25m8.024-9.75c.011.05.028.1.052.148.591 1.2.924 2.55.924 3.977a8.96 8.96 0 01-.999 4.125m.023-8.25c-.076-.365.183-.75.575-.75h.908c.889 0 1.713.518 1.972 1.368.339 1.11.521 2.287.532 3.486a2 2 0 01-2 2H15.61a2.25 2.25 0 00-2.25 2.25v2.793c0 .621.504 1.125 1.125 1.125h1.5a3.375 3.375 0 013.375 3.375M17.774 5.25c-.076-.365.183-.75.575-.75h.908c.889 0 1.713.518 1.972 1.368.339 1.11.521 2.287.532 3.486a2 2 0 01-2 2H15.61a2.25 2.25 0 00-2.25 2.25v2.793c0 .621.504 1.125 1.125 1.125h1.5a3.375 3.375 0 013.375 3.375M12 3v1.5M6 15v6m0 0H3.75a1.125 1.125 0 01-1.125-1.125v-1.5c0-.621.504-1.125 1.125-1.125H6z" />} />
);
