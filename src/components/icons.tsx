...
export const LightbulbIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.311a7.5 7.5 0 01-7.5 0c-1.421-.013-2.822-.24-4.144-.668a5.25 5.25 0 01-3.622-4.996V8.25a5.25 5.25 0 013.622-4.996l1.222-.44a11.99 11.99 0 018.902 0l1.222.44a5.25 5.25 0 013.622 4.996v4.428a5.25 5.25 0 01-3.622 4.996C17.822 19.51 16.421 19.737 15 19.752h-6z" />
    </svg>
);
