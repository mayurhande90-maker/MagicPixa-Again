...
export const UsersIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962A3.75 3.75 0 0115 12a3.75 3.75 0 01-2.25 3.512m-3.75-2.962a3.75 3.75 0 00-2.25-3.512A3.75 3.75 0 006 12a3.75 3.75 0 00-2.25 3.512M15 12a3.75 3.75 0 01-7.5 0" />
  </svg>
);
...
export const MicrophoneIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75a6 6 0 006-6v-1.5m-6 7.5a6 6 0 01-6-6v-1.5m12-9A6 6 0 006 3.75v1.5M12 18.75a6 6 0 00-6-6v-1.5m6 7.5v3.75m-3.75-3.75h7.5" />
  </svg>
);
...
export const GarmentTopIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5c-2 0-3.5 1-4.5 2.5S6 10.5 6 10.5V19h12v-8.5s-.5-2.5-1.5-4S14 4.5 12 4.5z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 5s-.5-1-1.5-1S6 5 6 5m9 0s.5-1 1.5-1S18 5 18 5" />
  </svg>
);

export const GarmentTrousersIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M8 3v3m0 0h8M8 6L6 21h4l2-6 2 6h4L16 6H8z" />
  </svg>
);

export const AdjustmentsVerticalIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6h3m-3 6h3m-3 6h3m-5.25-15h9.5A2.25 2.25 0 0121 5.25v13.5A2.25 2.25 0 0118.25 21h-9.5A2.25 2.25 0 016 18.75V5.25A2.25 2.25 0 018.25 3z" />
  </svg>
);
...
export const TicketIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 6v.75m0 3v.75m0 3v.75m0 3V18m-9-1.5h5.25m-5.25 0h3m-3 0h.008v.008H7.5V16.5zm0-3h5.25m-5.25 0h3m-3 0h.008v.008H7.5V13.5zm0-3h5.25m-5.25 0h3m-3 0h.008v.008H7.5V10.5z M3 4.5A1.5 1.5 0 014.5 3h15A1.5 1.5 0 0121 4.5v15a1.5 1.5 0 01-1.5 1.5h-15A1.5 1.5 0 013 19.5v-15z" />
  </svg>
);
...
export const LeafIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M17 8C8 10 5.9 16.17 3.82 21.34L5.71 22l1.62-7.24L12 12l2.35 3.53L17 8z" />
  </svg>
);
...
export const DiamondIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M10.788 3.212a.75.75 0 01.976 0l6 6a.75.75 0 010 .976l-6 6a.75.75 0 01-.976 0l-6-6a.75.75 0 010-.976l6-6z" />
  </svg>
);
...
export const FlagIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 3v1.5M3 21v-6m0 0l2.77-.693a9 9 0 016.208.682l.108.054a9 9 0 006.086.71l3.114-.732a48.524 48.524 0 015.472-.375m-18 0a48.524 48.524 0 005.472.375m11.134 0a48.524 48.524 0 015.472-.375m-5.472.375l-3.114.732a9 9 0 01-6.086-.71l-.108-.054a9 9 0 00-6.208-.682L3 15m0 0v-1.5m18 4.5v-1.5m0 0l-3.83-1.436a9 9 0 00-7.34 0L3 18m0 0v-1.5" />
  </svg>
);
...
export const MagicPixaLogo: React.FC<{ className?: string }> = ({ className }) => (
    <div className={`flex items-center gap-2 ${className}`}>
        <div className="bg-gradient-to-br from-[#f9d230] to-[#0079F2] p-2 rounded-lg">
            <SparklesIcon className="w-5 h-5 text-white" />
        </div>
        <span className="font-bold text-xl text-[#1E1E1E]">MagicPixa</span>
    </div>
);

export const AudioWaveIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12.75 19.5v-15m-4.5 15V4.5m-4.5 9V10.5m13.5 9V10.5m-4.5 9V4.5" />
  </svg>
);
...
export const CurrencyDollarIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 11.249 12.768 11 12 11c-.768 0-1.536.249-2.121.737L9 11.25m-3 2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 11.249 12.768 11 12 11c-.768 0-1.536.249-2.121.737L9 11.25m0 0c-1.171-.879-1.171-2.303 0-3.182C9.464 7.249 10.232 7 11 7c.768 0 1.536.249 2.121.737L15 8.25m-3-1.5V6m3 2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C19.536 8.249 18.768 8 18 8c-.768 0-1.536.249-2.121.737L15 8.25" />
  </svg>
);
