...
export const PixaEcommerceIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} width="200" height="200" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        <g fill="none">
            ...
            <path stroke="#191919" strokeLinecap="round" strokeLinejoin="round" d="m12.002 8.498l-5.81-2.42m2.803-1.366L15.19 7.17M12 19v4m-5.5 0h11M1 2a1 1 0 0 1 1-1h20a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1z"/>
            <path stroke="#191919" strokeLinecap="round" strokeLinejoin="round" d="M18 6.668v6.16a1.02 1.02 0 0 1-.62.93l-5 2.08a1 1 0 0 1-.38.07V8.5l5.81-2.42c.123.171.19.377.19.588"/>
            <path stroke="#191919" strokeLinecap="round" strokeLinejoin="round" d="M17.813 6.078L12 8.5v7.41a1.1 1.1 0 0 1-.39-.07l-5-2.12A.99.99 0 0 1 6 12.8V6.668a.99.99 0 0 1 .61-.92l5-2.09c.246-.1.522-.1.77 0l5 2.09c.17.069.32.183.431.33"/>
        </g>
    </svg>
);
...
export const MagicAdsIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 1000" xmlSpace="preserve">
        <g>
            ...
            <path fill="#382B73" d="M710.6 455.7h-37.2V353.4c0-13.8-11.2-25-25-25h-349c-13.8 0-25 11.2-25 25v246.7c0 13.8 11.2 25 25 25h131.7V675.5h-16.2c-13 0-23.6 9.9-24.9 22.5 0 .1-.1.1-.1.2V707c0 2.6 2.1 4.6 4.6 4.6h158.8c2.6 0 4.6-2.1 4.6-4.6v-8.8c0-.1-.1-.1-.1-.2-1.2-12.6-11.9-22.5-24.9-22.5h-16.2V625.1h62.9v71.4c0 8.3 6.7 15 15 15h116c8.3 0 15-6.7 15-15V470.7c0-8.3-6.7-15-15-15z"/>
            <g>
                <path fill="#FFC733" d="M648.4 605.1h-349c-13.8 0-25-11.2-25-25V333.4c0-13.8 11.2-25 25-25h348.9c13.8 0 25 11.2 25 25v246.7c.1 13.8-11.1 25-24.9 25z"/>
                <path fill="#FEDE3A" d="M647.3 597.5H300.5c-11 0-20-9-20-20V336c0-11 9-20 20-20h346.9c11 0 20 9 20 20v241.5c-.1 11.1-9 20-20.1 20z"/>
                <path fill="#FFC733" d="M632.6 565.7H315.2c-11 0-20-9-20-20V351.3c0-11 9-20 20-20h317.4c11 0 20 9 20 20v194.4c0 11-9 20-20 20z"/>
                <path fill="#EF5A9D" d="M630.9 558.9h-314c-8.3 0-15-6.7-15-15V352.2c0-8.3 6.7-15 15-15H631c8.3 0 15 6.7 15 15v191.7c-.1 8.3-6.8 15-15.1 15z"/>
                <path fill="#A72973" d="M632 337.2H315.8c-7.7 0-13.9 6.2-13.9 13.9v10.7c0-7.7 6.2-13.9 13.9-13.9H632c7.7 0 13.9 6.2 13.9 13.9v-10.7c0-7.7-6.2-13.9-13.9-13.9z"/>
                <path fill="#FEDE3A" d="M532.9 655.5h-118c-13.8 0-25 11.2-25 25v6.1c0 2.8 2.2 5 5 5h158c2.8 0 5-2.2 5-5v-6.1c0-13.8-11.2-25-25-25z"/>
                <path fill="#FFC733" d="M538.4 667.6h-129c-8.2 0-15.4 4.2-19.5 10.6v8.7c0 2.6 2.1 4.6 4.6 4.6h158.8c2.6 0 4.6-2.1 4.6-4.6v-8.7c-4.1-6.4-11.3-10.6-19.5-10.6z"/>
                <path fill="#1CAEE4" d="M431.1 605.1h85.6v50.4h-85.6z"/>
                <path fill="#177BC0" d="M431.1 605.1h85.6v13.3h-85.6z"/>
                <circle fill="#1CAEE4" cx="473.9" cy="581.3" r="9.3"/>
                <path fill="#177BC0" d="M473.9 587.1c-4.5 0-8.3-3.2-9.1-7.5-.1.6-.2 1.1-.2 1.7 0 5.1 4.2 9.3 9.3 9.3s9.3-4.2 9.3-9.3c0-.6-.1-1.2-.2-1.7-.8 4.3-4.6 7.5-9.1 7.5z"/>
                <g>
                    <path fill="#D1D3D4" d="M710.6 691.6h-116c-8.3 0-15-6.7-15-15V450.7c0-8.3 6.7-15 15-15h116c8.3 0 15 6.7 15 15v225.9c0 8.3-6.7 15-15 15z"/>
                    <path fill="#FFF" d="M710.4 685.7H594.7c-5.1 0-9.2-4.1-9.2-9.2V450.8c0-5.1 4.1-9.2 9.2-9.2h115.7c5.1 0 9.2 4.1 9.2 9.2v225.7c.1 5.1-4 9.2-9.2 9.2z"/>
                    <circle fill="#A72973" cx="652.6" cy="664.3" r="14.4"/>
                    <circle fill="#EF5A9D" cx="652.6" cy="664.3" r="9.2"/>
                    <path fill="#177BC0" d="M701.9 636h-98.7c-5.5 0-10-4.5-10-10V459.1c0-5.5 4.5-10 10-10h98.7c5.5 0 10 4.5 10 10V626c0 5.5-4.4 10-10 10z"/>
                    <path fill="#1CAEE4" d="M698.4 626.7h-91.7c-3.4 0-6.2-2.8-6.2-6.2V464.6c0-3.4 2.8-6.2 6.2-6.2h91.7c3.4 0 6.2 2.8 6.2 6.2v155.8c.1 3.5-2.7 6.3-6.2 6.3z"/>
                </g>
            </g>
        </g>
    </svg>
