...
export const PixaTogetherIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
        ...
        <path fill="#444" d="M99.94 99.35c-2.07 1.61-9.41 2.51-11.81 1.45c-1.38-.61-2.55.72-1.87 1.83c.66 1.08 4.99 3.25 8.45 2.83c3.46-.42 7.08-3.57 7.47-4.78c.39-1.24-1.05-2.25-2.24-1.33z"/>
