...
const Sidebar: React.FC<SidebarProps> = ({ user, setUser, activeView, setActiveView, navigateTo, appConfig, openReferralModal }) => {
  ...
  const allNavItems = [
    ...
    { id: 'apparel_staging', label: 'Staging: TryOn Lab', icon: CameraIcon, disabled: false, badge: 'DEV' }, // NEW
