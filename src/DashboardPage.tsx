                ...
                <div className={`flex flex-col ${contentHeightClass}`}>
                    <div className="bg-[#F6F7FA] p-5 rounded-3xl flex-1 flex-col h-full border border-gray-100 overflow-hidden flex">
                        ...
                        <div ref={scrollRef} className={`flex-1 ${disableScroll ? 'overflow-hidden' : 'overflow-y-auto custom-scrollbar'} pr-1 flex flex-col relative`}>
                            <div className="flex flex-col h-full justify-start pb-12">
                                {/* Content */}
                        ...
                        {!hideGenerateButton && (
                            <div className="pt-4 border-t border-gray-200 bg-[#F6F7FA] flex-shrink-0 z-10">
                                <button 
                                    onClick={onGenerate} 
...
const MagicPhotoStudio: React.FC<{ auth: AuthProps; navigateTo: any; appConfig: AppConfig | null }> = ({ auth, navigateTo, appConfig }) => {
    ...
    const autoScroll = () => {
        if (scrollRef.current) {
            ...
            }, 300); // Increased timeout for smoother auto-scroll after render
        }
    };
